        ...
        <div class="multisteps-form mb-5">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 m-auto">
                    <form class="multisteps-form__form" action="{{ route('vendor.stores.store') }}" method="POST"
                            ...
                            <div class="multisteps-form__content">
                                <div class="row mt-3 align-items-center">
                                    <div class="col-12 col-sm-4">
                                        ...
                                        @enderror
                                        <x-image-uploader name="logo" storeAsFile />

                                    </div>
                                    <div class="col-12 col-sm-8 mt-4 mt-sm-0 text-start">
                                        <label>@lang('main.business_name')</label>
                                        @error('business_name')
                                        <small class="text text-danger">{{$message}}</small>
                                        @enderror
                                ...
                                <div class="button-row d-flex mt-4">
                                    <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button"
                                        title="Next">@lang('main.next')</button>
                                </div>
                            </div>
                        </div>
                        <!--single form panel-->
                        ...
                        <div class="card multisteps-form__panel p-3 border-radius-xl bg-white" data-animation="FadeIn">
                            <div class="row text-center">
                                <div class="col-10 mx-auto">
                                    <h5 class="font-weight-normal">Are your business in a nice area?</h5>
                                </div>
                            </div>
                            <div class="multisteps-form__content">
                                ...
                                <div class="row">
                                    <div
                                        class="button-row d-flex justify-content-between align-content-center mt-4 col-12">
                                        <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                            title="Prev">@lang('main.prev')</button>
                                        <button class="btn bg-gradient-dark mb-0" type="submit"
                                            title="Send">@lang('main.send')</button>
                                    </div>
                                </div>
                            </div>
                        </div>
