<aside
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            @can('browse vendor')
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#vendorsNav" @class(['nav-link', 'active'=>
                    request()->routeIs('admin.vendors.index')])
                    aria-controls="vendorsNav" role="button"
                    aria-expanded="{{request()->routeIs('admin.vendors.index') ? 'true' : 'false'}}">
                    <div
                    ...
                    <span class="nav-link-text ms-1">@lang('main.vendors')</span>
                </a>
                <div @class(['collapse', 'show'=> request()->routeIs('admin.vendors.index')])
                    id="vendorsNav">
                    <ul class="nav ms-4 ps-3">
                        <li @class(['nav-item', 'active'=> request()->routeIs('admin.vendors.index')])>
                            <a @class(['nav-link', 'active'=> request()->routeIs('admin.vendors.index')])
                                href="{{route('admin.vendors.index')}}">
                                <span class="sidenav-mini-icon"> V </span>
                                <span class="sidenav-normal"> @lang('main.vendors') </span>
                            </a>
                        </li>
                        {{-- <li class="nav-item ">
